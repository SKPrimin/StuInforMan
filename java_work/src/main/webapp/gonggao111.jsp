  ...
  <body>
    <%      //接收用户名和密码  
    		...
    		try {
    			...
    			//5.执行SQL语句
                String usern=request.getParameter("name1");

                stmt.execute("insert into 公告 values('" + usern+ "'");
                //6.访问结果集ResultSet对象"rs"
%>
            	<h1 style="font-family:arial;color:red;font-size:70px; ">用户注册成功！</h1>
            	 <a href="dlu.jsp">返回登录</a> <%  
    			//7.依次关闭 rs , stmt ,conn
    			rs.close();
    			stmt.close();
    			conn.close();
